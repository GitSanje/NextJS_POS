        ...
        <>
         <FormItem>
          ...
          <Select.Root 
           ...
           >
            <Select.Trigger 
              className= {cn("p-2 border-2 border-indigo-500 rounded-md flex gap-4 items-center text-sm text-gray-700 bg-white hover:bg-indigo-50 focus:outline-none focus:ring-2 focus:ring-indigo-500 transition duration-150 ease-in-out",
